...
\begin{lemma}\label{improved zhijie lemma} Let real-valued $f\in L_1^{{\rm loc}}(\mathbb{R}^N)$ be such that the commutator $[R_{{\rm Dunkl},j},M_f]$ is bounded on $L_2(\mathbb{R}^N,w(x)dx).$ For every $Q\in\mathcal{D},$ there exist $e_Q$ and $f_Q$ supported in $7Q$ such that $\|e_Q\|_{\infty},\|f_Q\|_{\infty}\leq m(Q)^{-\frac12}$ and such that
$$\frac1{w(Q)}\int_{3Q}|f(y)-f_{3Q}|w(y)dy\leq c_k|\langle[R_{{\rm Dunkl},j},M_f]e_Q,f_Q\rangle_{L_2(\mathbb{R}^N,w(x)dx)}|.$$
\end{lemma}
...
$$e_{Q,s}=w(Q)^{-\frac12}\chi_{A_s},\quad f_{Q,s}=w(Q)^{-\frac12}\chi_{B_s},\quad s=1,2.$$

We have
$$\langle[R_{{\rm Dunkl},j},M_f]e_{Q,s},f_{Q,s}\rangle_{L_2(\mathbb{R}^N,w(x)dx)}=$$
...
Thus,
$$\langle[R_{{\rm Dunkl},j},M_f]e_{Q,1},f_{Q,1}\rangle_{L_2(\mathbb{R}^N,w(x)dx)}\geq $$
...
and
$$-\langle[R_{{\rm Dunkl},j},M_f]e_{Q,2},f_{Q,2}\rangle_{L_2(\mathbb{R}^N,w(x)dx)}\geq $$
...
$$\frac{c_k'}{w(Q)}\int_{3Q}|f(y)-\alpha|w(y)dy\leq\max_{s=1,2}|\langle[R_{{\rm Dunkl},j},M_f]e_{Q,s},f_{Q,s}\rangle_{L_2(\mathbb{R}^N,w(x)dx)}|.$$

If 
$$|\langle[R_{{\rm Dunkl},j},M_f]e_{Q,1},f_{Q,1}\rangle_{L_2(\mathbb{R}^N,w(x)dx)}|\geq |\langle[R_{{\rm Dunkl},j},M_f]e_{Q,2},f_{Q,2}\rangle_{L_2(\mathbb{R}^N,w(x)dx)}|,$$
then we set $e_Q=e_{Q,1}$ and $f=f_{Q,1}.$ Otherwise, set $e_Q=e_{Q,2}$ and $f_Q=f_{Q,2}.$ Thus,
$$\frac{c_k'}{w(Q)}\int_{3Q}|f(y)-\alpha|w(y)dy\leq|\langle[R_{{\rm Dunkl},j},M_f]e_Q,f_Q\rangle_{L_2(\mathbb{R}^N,w(x)dx)}|.$$
Hence,
$$c_k'|f_{3Q}-\alpha|\leq|\langle[R_{{\rm Dunkl},j},M_f]e_Q,f_Q\rangle_{L_2(\mathbb{R}^N,w(x)dx)}|$$
and, finally,
$$\frac{c_k'}{w(Q)}\int_{3Q}|f(y)-f_{3Q}|w(y)dy\leq 2|\langle[R_{{\rm Dunkl},j},M_f]e_Q,f_Q\rangle_{L_2(\mathbb{R}^N,w(x)dx)}|.$$
\end{proof}
...
$$\Big\{\frac1{w(Q)}\int_{3Q}|f(x)-f_{3Q}|w(x)dx\Big\}_{Q\in\mathcal{D}}\in l_p.$$
\end{lemma}
\begin{proof} Let $\{e_Q\}_{Q\in\mathcal{D}}$ and $\{f_Q\}_{Q\in\mathcal{D}}$ be functions constructed in Lemma \ref{improved zhijie lemma}. By {\color{red} some version of Rochberg-Semmes theorem PROOF OR REFERENCE IS NEEDED},
$$\Big\{\langle [R_{{\rm Dunkl},j},M_f]e_Q,f_Q\rangle_{L_2(\mathbb{R}^N,w(x)dx)}\Big\}_{Q\in\mathcal{D}}\in l_p.$$
