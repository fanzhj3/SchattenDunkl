...
$$\|f\|_{B^p(\mathbb{R}^N,w(x)dx)}^p\leq c_{p,k}\sum_{l\in\mathbb{Z}}\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-l}))}+$$
...
$$\leq c_{p,k}\sum_{m\in\mathbb{Z}}\int_{\mathbb{R}^N}\frac{|f(x)-(E_mf)(x)|^pw(x)dx}{w(B(x,2^{-m}))}.$$
Thus,
$$\|f\|_{B^p(\mathbb{R}^N,w(x)dx)}^p\leq  c_{p,k}\sum_{m\in\mathbb{Z}}\int_{\mathbb{R}^N}\frac{|f(x)-(E_mf)(x)|^pw(x)dx}{w(B(x,2^{-m}))}+$$
$$+c_{p,k}\sum_{Q\in\mathcal{D}}\Big(\frac1{w(3Q)}\int_{3Q}|f(x)-f_{3Q}|w(x)dx\Big)^p.$$
...
$$\leq\sum_{l\geq m}\Big(\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-m}))}\Big)^{\frac1p}.$$
Note that
$$w(B(x,2^{-m}))\geq c_k 2^{N(l-m)}w(B(x,2^{-l})).$$
Thus,
$$\Big(\int_{\mathbb{R}^N}\frac{|f(x)-(E_mf)(x)|^pw(x)dx}{w(B(x,2^{-m}))}\Big)^{\frac1p}\leq$$
$$\leq c_{p,k}\sum_{l\geq m}2^{\frac{N(m-l)}{p}}\Big(\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-l}))}\Big)^{\frac1p}$$
and, therefore,
$$\sum_{m\in\mathbb{Z}}\int_{\mathbb{R}^N}\frac{|f(x)-(E_mf)(x)|^pw(x)dx}{w(B(x,2^{-m}))}\leq$$
$$\leq c_{p,k}\sum_{m\in\mathbb{Z}}\Big(\sum_{l\geq m}2^{\frac{N(m-l)}{p}}\Big(\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-l}))}\Big)^{\frac1p}\Big)^p.$$

Using the discreet Young's inequality
$$\|a\ast b\|_p\leq\|a\|_1\|b\|_p$$
with
$$a(l)=2^{-\frac{Nl}{p}}\chi_{\mathbb{Z}_+}(l),\quad b(l)=\Big(\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-l}))}\Big)^{\frac1p},$$
we obtain
$$\sum_{m\in\mathbb{Z}}\Big(\sum_{l\geq m}2^{\frac{N(m-l)}{p}}\Big(\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-l}))}\Big)^{\frac1p}\Big)^p\leq$$
$$\leq c_{N,p}\sum_{l\in\mathbb{Z}}\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-l}))}.$$
Thus,
$$\sum_{m\in\mathbb{Z}}\int_{\mathbb{R}^N}\frac{|f(x)-(E_mf)(x)|^pw(x)dx}{w(B(x,2^{-m}))}\leq$$
$$\leq c_{p,k}\sum_{l\in\mathbb{Z}}\int_{\mathbb{R}^N}\frac{|(E_{l+1}f)(x)-(E_ff)(x)|^pw(x)dx}{w(B(x,2^{-l}))}.$$
This completes the proof.
\end{proof}
