...
2<r<\infty.
$
Then there exist a constant $C>0$, nonnegative numbers
$
\{c_{p,q}\}_{p,q\in\mathbb Z^N},
$ functions
$
\{e_{p,q,I}^{\sigma,\tau}\}_{p,q\in\mathbb Z^N,I\in\mathbb D_\Gamma,\sigma,\tau\in G},$ $
\{
h_{p,q,I}^{\sigma,\tau}\}_{p,q\in\mathbb Z^N,I\in\mathbb D_\Gamma,\sigma,\tau\in G},
$
such that
\begin{enumerate}
  \item for every $M>0$,\begin{equation}\label{eq:Dunkl-cpq-decay}
c_{p,q}
\leq
C_M(1+|p|+|q|)^{-M},
\qquad
...
\leq
w(I)^{\frac1r-\frac12},\qquad \|h_{p,q,I}^{\sigma,\tau}\|_{L^r(\mathbb R^N,dw)}\leq w(I)^{\frac1r-\frac12};
\end{equation}
\item
For every $f\in L^r_{\mathrm{loc}}(\mathbb R^N,dw)$ and for almost every $(x,y)$ with $d(x,y)>0$,
