...
\(u,v\in\mathbb Z^N\), Lemma~\ref{lem:Dunkl-commutator-Fourier-NWO-endpoint}
\eqref{comm-property2}--\eqref{comm-property3}, together with the
\(G\)-invariance of \(dw\), show that
\[
\left\{
...
\right\}_{I\in\mathbb D_\Gamma}
\]
are NWO families on \(\Gamma\). Indeed, their supports are contained in
\(I\) and \(I^*\), respectively, and \(I^*\) is contained in a fixed
enlargement of \(I\).

The operator
\begin{align}\label{heoperator}
\sum_{I\in\mathbb D_\Gamma}
A_{\sigma,\tau,I,\varepsilon}(f)
\left\langle
\,\cdot,\,
...
E_{u,v,I,\varepsilon}^{\sigma,\tau}
\end{align}
acts from \(L^2(\tau\Gamma,dw)\) to \(L^2(\sigma\Gamma,dw)\). For \(\gamma\in G\), define
\[
U_\gamma:L^2(\Gamma,dw)\longrightarrow L^2(\gamma\Gamma,dw),
\qquad
U_\gamma g(x):=g(\gamma^{-1}x).
\]
By the \(G\)-invariance of \(dw\), \(U_\gamma\) is unitary. By Lemma~\ref{lem:Dunkl-commutator-Fourier-NWO-endpoint} \eqref{comm-property2}, the operator \eqref{heoperator} vanishes on
\(L^2(\tau\Gamma,dw)^\perp\), while its range is contained in
\(L^2(\sigma\Gamma,dw)\). Note that for \(g\in L^2(\Gamma,dw)\),
\begin{align*}
&U_\sigma^{-1}
\Bigg(
\sum_{I\in\mathbb D_\Gamma}
...
E_{u,v,I,\varepsilon}^{\sigma,\tau}(\sigma\,\cdot).
\end{align*}
Hence, by Lemma~\ref{NWOLEMMAA2} and Lemma~\ref{lem:Dunkl-commutator-Fourier-NWO-endpoint} \eqref{comm-property4},
\begin{align*}
&\left\|
\sum_{I\in\mathbb D_\Gamma}
A_{\sigma,\tau,I,\varepsilon}(f)
...
\right\rangle_{L^2(\mathbb R^N,dw)}
E_{u,v,I,\varepsilon}^{\sigma,\tau}
\right\|_{S^{p,q}(L^2(\mathbb R^N,dw))}
\\
&\qquad=
\left\|
\sum_{I\in\mathbb D_\Gamma}
...
Choose \(M_0>2N\). By Lemma~\ref{lem:Dunkl-commutator-Fourier-NWO-endpoint} \eqref{comm-property1},
\[
\sum_{u,v\in\mathbb Z^N}|c_{u,v}|<\infty.
\]
 As \(G\) is finite,
the operator series in \eqref{eq:Dunkl-commutator-kernel-NWO} therefore
